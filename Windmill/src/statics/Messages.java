...
public class Messages {
    ...
    public static final String NEXT_SLUG_ASSIGN = "Next slug assign";
    ...
    public static final String STATE_PLACING_SLUGS = "Placing slugs";
    public static final String STATE_PLAYING = "Placing slugs";
